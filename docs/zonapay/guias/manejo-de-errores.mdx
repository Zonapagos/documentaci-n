...
<Check>**Nunca muestres `str_descripcion_error` crudo al usuario.** Puede contener nombres de variables internas o info sensible.</Check>
<Check>**Mapea errores técnicos a mensajes de negocio:**
